        ...
        return(
            <div id="contact-wrapper">
                <div id="contact-body">
                    ...
                    <div id="contact-logo">Résumé<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><img className="resume-logo" src="https://www.base64-image.de/build/img/mr-base64-482fa1f767.png"/></a></div>
                </div>
            </div>
